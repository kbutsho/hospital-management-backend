...
class DepartmentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $department = [
            ...
            ['name' => 'Orthopedics', 'description' => "Orthopedics is a medical specialty that focuses on the diagnosis, treatment, and prevention of disorders and injuries affecting the musculoskeletal system. This system includes bones, joints, muscles, ligaments, tendons, and nerves. Orthopedic surgeons are trained to address a wide range of conditions, such as fractures, arthritis, sports injuries, spinal deformities, and congenital disorders. They employ various treatment modalities, including surgical interventions, medications, physical therapy, and rehabilitative techniques, tailored to each patient's unique needs. The goal of orthopedic care is to restore mobility, alleviate pain, and improve the overall function and quality of life for individuals with musculoskeletal issues.", 'photo' => '2.png', 'status' => STATUS::ACTIVE, 'created_at' => now(), 'updated_at' => now()],
